<?php
/*
* Template Name: Speakers - category - Wordpress
*/
get_header();
$speakers_category_wordpress = get_field('speakers_category_wordpress');
$categories = $speakers_category_wordpress['categories']; ?>
<style>
	h1, h2, h3, h4, h5, h6 {
		width: 100%;
	}
		...
		<div class="st-p">
			<div class="container-fluid">
				...
				$args = array(
					...
					'offset'            => 0,
					'post_status'      => 'publish',
					'cat'              => $category['category'], // id of the category
				);
				// query
					...
					<div class="row justify-content-center">
						...
						while ($wp_query->have_posts()) {
							...
							<div class="col-12 col-sm-6 col-md-4 col-lg-20 pb-3" id="speaker">
								...
								<a class="d-block speaker_title" data-toggle="modal" data-target="#speaker-<?php the_ID() ?>">
							...
							<!-- Modal -->
							<div class="modal fade" id="speaker-<?php the_ID() ?>" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="speaker-<?php the_ID() ?>Title" aria-hidden="true">
